...
/**
 * Class Version20220426053051
 */
final class Version20220426053051 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE retrait (ret_id INT AUTO_INCREMENT NOT NULL, ret_dab INT DEFAULT NULL, ret_date DATETIME NOT NULL, ret_numcarte VARCHAR(50) DEFAULT NULL, INDEX IDX_D9846A51B11AE000 (ret_dab), PRIMARY KEY(ret_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
